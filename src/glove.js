...
export default class CustomGloveTool {
    ...
    constructor(options = {}) {
        ...
        {
            "productId": "56",
            "designTemplate": "first-base-dual-tone",
            "build": {
                "body": ["_x5F_wst", "_x5F_bnd", "_x5F_stch", "_x5F_lce", "_x5F_bfg","_x5F_thb"],
        ...
        {
            "productId": "56",
            "designTemplate": "catchers-dual-tone",
            "build": {
...
loadInfield2Welt() {
    ...
    Snap.load("assets/images/infield_dwelt_back.svg", (f) => {
        ...
        var g = f.selectAll('#inf_x5F_vw3_x5F_bfg, #inf_x5F_vw3_x5F_mid, #inf_x5F_vw3_x5F_wst, #inf_x5F_vw3_x5F_wlt, #inf_x5F_vw3_x5F_bnd, #inf_x5F_vw3_x5F_logo, #inf_x5F_vw3_x5F_web, #inf_x5F_vw3_x5F_plm, #inf_x5F_vw3_x5F_stch, #inf_x5F_vw3_x5F_lce, #inf_x5F_vw3_x5F_rse, inf_x5F_vw3_x5F_elt, inf_x5F_elite_x5F_logo');
        g.forEach((el, i) => {
            var p = ["inf_x5F_vw3_x5F_bfg", "inf_x5F_vw3_x5F_mid", "inf_x5F_vw3_x5F_wst", "inf_x5F_vw3_x5F_wlt", "inf_x5F_vw3_x5F_bnd", "inf_x5F_vw3_x5F_logo", "inf_x5F_vw3_x5F_web", "inf_x5F_vw3_x5F_plm", "inf_x5F_vw3_x5F_stch", "inf_x5F_vw3_x5F_lce", "inf_x5F_vw3_x5F_rse", "inf_x5F_vw3_x5F_elt", "inf_x5F_elite_x5F_logo"];
            var layer = p[i];
            var filter = layer.split('_').pop();
    ...
    Snap.load("assets/images/infield_dwelt_pocket.svg", (f) => {
        this.svgInside.attr({ viewBox: "0 0 400 400" });
        // this.gloveCloneInsideVertical.attr({ viewBox: "0 0 400 400" });
        var g = f.selectAll('#inf_x5F_vw2_x5F_web, #inf_x5F_vw2_x5F_plm, #inf_x5F_vw2_x5F_mid, #inf_x5F_vw2_x5F_bfg, #inf_x5F_vw2_x5F_wlt, #inf_x5F_vw2_x5F_bnd,#inf_x5F_vw2_x5F_stch, #inf_x5F_vw2_x5F_lce');
        g.forEach((el, i) => {
            var p = ["inf_x5F_vw2_x5F_web", "inf_x5F_vw2_x5F_plm", "inf_x5F_vw2_x5F_mid", "inf_x5F_vw2_x5F_bfg", "inf_x5F_vw2_x5F_wlt", "inf_x5F_vw2_x5F_bnd", "inf_x5F_vw2_x5F_stch", "inf_x5F_vw2_x5F_lce"];
            var layer = p[i];
    ...
    Snap.load("assets/images/infield_dwelt_side.svg", (f) => {
        this.svgSide.attr({ viewBox: "0 0 400 400" });
        // this.gloveCloneSideVertical.attr({ viewBox: "0 0 400 400" });
        var g = f.selectAll('#inf_x5F_vw1_x5F_plm, #inf_x5F_vw1_x5F_bfg, #inf_x5F_vw1_x5F_mid, #inf_x5F_vw1_x5F_wlt, #inf_x5F_vw1_x5F_web, #inf_x5F_vw1_x5F_wst, #inf_x5F_vw1_x5F_stch, #inf_x5F_vw1_x5F_bnd, #inf_x5F_vw1_x5F_lce, #inf_x5F_vw1_x5F_logo');

        g.forEach((el, i) => {
            var p = ["inf_x5F_vw1_x5F_plm", "inf_x5F_vw1_x5F_bfg", "inf_x5F_vw1_x5F_mid", "inf_x5F_vw1_x5F_wlt", "inf_x5F_vw1_x5F_web", "inf_x5F_vw1_x5F_wst", "inf_x5F_vw1_x5F_stch", "inf_x5F_vw1_x5F_bnd", "inf_x5F_vw1_x5F_lce", "inf_x5F_vw1_x5F_logo"];
